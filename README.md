# QueryMaster AI Project

Repositori ini memuat *deliverables* untuk proyek pembuatan **QueryMaster AI**, sebuah Education Bot & Personal Productivity Assistant berbasis platform Antigravity.
...
- Memecahkan masalah manajemen basis data (SQL Server & SQLite).
- Merancang query kompleks (Fungsi agregat, CASE, perulangan, dsb.).
- Memahami manipulasi data Frontend/Backend (Parsing JSON, JavaScript callbacks).
